...
class AgentsTags(Base):
    ...
    __table_args__ = (UniqueConstraint("agent_id", "tag", name="unique_agent_tag"), {"schema": "mirix"},)
    ...
    agent_id: Mapped[String] = mapped_column(String, ForeignKey("mirix.agents.id"), primary_key=True)
